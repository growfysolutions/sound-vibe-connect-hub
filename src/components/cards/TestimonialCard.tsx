...
export const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-2 left-2 text-6xl text-ocean-blue/20 font-serif leading-none">
        "
      </div>
      <div className="absolute bottom-2 right-2 text-6xl text-ocean-blue/20 font-serif leading-none rotate-180">
        "
      </div>
      ...
      <div className="relative z-10 space-y-4 pt-6">
        ...
        <div className="flex items-center space-x-3 pt-2">
          <div className="relative">
            <Avatar className="w-12 h-12 border-2 border-ocean-blue/30 ring-2 ring-ocean-blue/10">
            ...
            <div className="absolute -inset-1 border-2 border-ocean-blue/20 rounded-full -z-10"></div>
          </div>
        ...
        <div className={cn(culturalStyles.patterns.modern, 'rounded-lg p-3 mt-4 border border-ocean-blue/20')}>
          <div className="flex items-center justify-between">
            ...
            {testimonial.project.link && (
              <button
                ...
                className={cn(culturalStyles.colors.primary, 'hover:text-ocean-blue/80 transition-colors')}
              >
