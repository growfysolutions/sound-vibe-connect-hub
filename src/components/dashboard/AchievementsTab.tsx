      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="font-semibold text-foreground">{stats.totalPoints} XP</span>
          </div>
        </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-foreground">{stats.completedAchievements}/{stats.totalAchievements}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-foreground">{stats.nextMilestone}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-foreground">{Math.round((stats.completedAchievements / stats.totalAchievements) * 100)}%</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {achievements.map((achievement) => {
            ...
            return (
              <Card key={achievement.id} className={`relative overflow-hidden bg-card ${achievement.completed ? 'border-green-500/50' : ''}`}>
