    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          ...
          className={cn(
            "w-16 h-16 rounded-full shadow-lg shadow-saffron/20",
            "bg-gradient-to-r from-saffron to-amber-500",
        ...
        >
          ...
          <span className="sr-only">New Collaboration</span>
        </Button>
      </div>
          ...
          {quickActions.map((action, index) => {
            ...
            return (
              <Button
                ...
                className={cn(
                  "rounded-full w-12 h-12 text-white shadow-sm",
                  "transition-all duration-300 hover:scale-110 active:scale-95",
                  action.className
                )}
                size="icon"
